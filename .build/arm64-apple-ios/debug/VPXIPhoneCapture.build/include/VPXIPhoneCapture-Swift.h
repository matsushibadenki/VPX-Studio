...
#ifndef VPXIPHONECAPTURE_SWIFT_H
#define VPXIPHONECAPTURE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VPXIPhoneCapture",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class ARSession;
@class ARFrame;
@interface IPhoneCaptureCoordinator (SWIFT_EXTENSION(VPXIPhoneCapture)) <ARSessionDelegate>
